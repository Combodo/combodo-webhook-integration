...
Dict::Add('EN GB', 'British English', 'British English', array(
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:theme_color+' => 'Highlight colour of the message card in Microsoft Teams, must be a valid hexadecimal colour (eg. FF0000)',
